...
\usepackage{titlesec, blindtext, xcolor, lipsum}
%\usepackage[Sonny]{fncychap}

\setcounter{secnumdepth}{5}

\definecolor[named]{fgvBlue}{RGB}{29,43,107}
\definecolor[named]{fgvBlueHeading3}{RGB}{79,129,189}


\setkomafont{title}{\esititle}
\newcommand{\esititle}[1]{%
    \color{fgvBlue}%
    \normalfont\huge\uppercase{}%

}

\setkomafont{subsection}{\esisection}
\newcommand{\esisection}[1]{%
    \Large\sf\bf%
...
\setkomafont{subsubsection}{\esisubsection}
\newcommand{\esisubsection}[1]{%
    \Large\sf\bf%
    \setlength{\fboxsep}{0cm}%already boxed
    \color{black}%
    \colorbox{gray!12.5}{%
...
\setkomafont{paragraph}{\esisubsubsection}
\newcommand{\esisubsubsection}[1]{%
    \Large\sf\bf%
    \setlength{\fboxsep}{0cm}%already boxed
    \color{fgvBlueHeading3}%
    \colorbox{white}{%
    \begin{minipage}{\linewidth}%
        \vspace*{2pt}%Space before 
        #1
...
%\setkomafont{paragraph}{\esisubsubsubsection}
%\newcommand{\esisubsubsubsection}[1]{%
%    \Large\sf\bf%
%    \setlength{\fboxsep}{0cm}%already boxed
%    \color{fgvBlueHeading3}%
%    \colorbox{white}{%
...
%\advance\rightskip+10cm
%\vspace{-80pt}
\includegraphics[keepaspectratio=true,width=200mm]{../Dist/Images/Topo-Reports.png}
